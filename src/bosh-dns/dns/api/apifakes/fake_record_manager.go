...
type FakeRecordManager struct {
	FilterStub        func(aliasExpansions []string) ([]records.Record, error)
...
func (fake *FakeRecordManager) Filter(aliasExpansions []string) ([]records.Record, error) {
	...
	fake.recordInvocation("Filter", []interface{}{aliasExpansionsCopy})
	fake.filterMutex.Unlock()
	if fake.FilterStub != nil {
		return fake.FilterStub(aliasExpansions)
	}
	if specificReturn {
...
func (fake *FakeRecordManager) FilterArgsForCall(i int) []string {
	fake.filterMutex.RLock()
	defer fake.filterMutex.RUnlock()
	return fake.filterArgsForCall[i].aliasExpansions
}
